...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2016 a las 01:03:39
...
(9, 'MARCK MAX ', 3),
(10, 'roman lenght el arte de la vida', 6);
...
(7, 'el parcial de segunda instancia solo se acreditara a las personas que tienen un promedio de 26 o mayor entre sus dos parciales ssdff dfdf', 1),
(8, 'quinta face', 6);
...
(3, 'Gustabo Augusto', 'Fernandez', 'Jimenes', 'Ing. De Sistemas ', 4567378, 6754785, 'gustago_Augusto@gmail.com ', 'zona Condebamba y calle Segunda', 'amankalla', '32423'),
(4, 'Isrrael Cesar', 'Lobo', 'Vargas', 'Ing. De Sistemas', 567890, 78900, 'loba@gmail.com', '', 'lobo', '12345'),
(7, 'Augusto  ', 'Frut  ', 'Postre', 'Ing. De Sistemas  ', 35523, 376476, 'augusto@gmail.com  ', 'Calle cirvulanda entre hispana #154  ', 'augusto', '123456789'),
...
(21, 'LA METODOLOGIA ROBINSON', 6),
(25, 'aaaa', 4),
(32, 'el campo es un buen lugar para andar y descanzar', 2),
(33, 'Durante las últimas décadas, el campo de la Graficación por Computadora ha evolucionado de\r\nuna manera continua y rápida aplicándose a diversas áreas del saber humano que van desde la\r\nsimulación hasta el entretenimiento, muchas de las cuales han maravillado e impactado a la\r\nsociedad.\r\nEntre las numerosas aplicaciones, podemos mencionar las siguientes: Interfaces GUI, Industria\r\ndel Entretenimiento, Aplicaciones Comerciales, Diseño Asistido, Aplicaciones Científicas,\r\nMedicina, Cartografía y GIS.\r\nTodos estos sistemas, utilizados para fines tan diversos, tienen un fundamento subyacente que\r\nconsiste en una seria de técnicas derivadas de la aplicación de la Graficación por Computadora.\r\nEn este contexto se hace necesario un estudio de los algoritmos y técnicas gráficas que\r\npermitan el desarrollo de nuevas aplicaciones para solucionar diversos problemas que se\r\npresentan.\r\n\r\nhasta el entretenimiento, muchas de las cuales han maravillado e impactado a la\r\nsociedad.\r\nEntre las numerosas aplicaciones, podemos mencionar las siguientes: Interfaces GUI, Industria\r\n\r\n\r\n', 2),
(35, 'Durante las últimas décadas, el campo de la Graficación por Computadora ha evolucionado de\r\nuna manera continua y rápida aplicándose a diversas áreas del saber humano que van desde la\r\nsimulación hasta el entretenimiento, muchas de las cuales han maravillado e impactado a la\r\nsociedad.\r\nEntre las numerosas aplicaciones, podemos mencionar las siguientes: Interfaces GUI, Industria\r\ndel Entretenimiento, Aplicaciones Comerciales, Diseño Asistido, Aplicaciones Científicas,\r\nMedicina, Cartografía y GIS.\r\nTodos estos sistemas, utilizados para fines tan diversos, tienen un fundamento subyacente que\r\nconsiste en una seria de técnicas derivadas de la aplicación de la Graficación por Computadora.\r\nEn este contexto se hace necesario un estudio de los algoritmos y técnicas gráficas que\r\npermitan el desarrollo de nuevas aplicaciones para solucionar diversos problemas que se\r\npresentan.\r\n\r\nhasta el entretenimiento, muchas de las cuales han maravillado e impactado a la\r\nsociedad.\r\nEntre las numerosas aplicaciones, podemos mencionar las siguientes: Interfaces GUI, Industria\r\n\r\n\r\n', 1);
...
(8, 'Se tomara la toma de los respectivos parciales y examen final y de mesa', 1),
(9, 'cuarta face', 6);
...
(22, 4, 'una manta'),
(24, 5, 'hola mam'),
(25, 1, 'Un mundo sin esperanza es el caos de todos los males habidos y por haber'),
(26, 1, 'Los pajarillos cantan porque hay un nuevo dia para volar y encontrar un hogar'),
(27, 6, 'aca esta la segunda prueba');
...
(12, 'Aplicacion de redes de navegacion', 28),
(13, 'El mundo esta lleno de adas', 29),
(14, 'el mundo rencoroso se vengara con sus actores', 29),
(15, 'la concentracion del sol', 30),
(16, 'la razon por la cual estar feliz', 30);
...
(15, ' MATAMBA', 23),
(16, ' ANOTHER', 26),
(18, 'una escuela de sinceridad', 27),
(20, ' son mamiferos', 27),
(22, ' la historia de jack froz', 34),
(23, ' habita el mar azil', 27),
(24, 'Comandos para piratear', 28),
(25, ' Una dulce esperanza', 29),
(26, ' una dulce compania', 29),
(27, ' El artel del ki', 30),
(28, ' el arte colosal', 30),
(29, ' as', 27);
...
(28, 'EL BARCO SE REVELA POR SEGUNDA VEZ ', 2, 12, 2, 1),
(29, 'El joven Hornerito', 1, 12, 2, 6),
(30, 'Relajamineto muscular', 2, 12, 2, 6);
...
--
ALTER TABLE `bibliografia`
  MODIFY `Id_Bibliografia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `justificacion`
  MODIFY `Id_Justificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `metodologia`
  MODIFY `ID_Metod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `objetivo`
--
ALTER TABLE `objetivo`
  MODIFY `ID_Objetivos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT de la tabla `planglobal`
--
ALTER TABLE `planglobal`
  MODIFY `ID_PG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `seccion_objetivo`
  MODIFY `ID_Objetivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
