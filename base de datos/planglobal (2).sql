...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2016 a las 03:51:32
...
(6, 'FISICA I', 2001021, '1', 'A', '20 hrs/Semana', 'FISCA II, FISICA III, ELECTROTECNIA', 1),
...
(5, ' SISTEMAS EXPERTOS DE COMPUTACION', 3, 3),
(9, ' SISTEMAS DE GLOBALIZACION E INFRAESTRUCTURAS ARQUITECTURAS', 5, 3),
(12, ' INTRODUCCION A LA VEROSINIA', 5, 3),
(22, ' BOSSANOVA', 6, 3),
(23, ' LACUNA COIL', 7, 3),
(24, ' BACHUN', 8, 3),
(25, ' JUAN PINTO', 9, 3),
...
--
ALTER TABLE `justificacion`
  MODIFY `Id_Justificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `objetivos`
  MODIFY `ID_Objetivos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `seccion_objetivo`
  MODIFY `ID_Objetivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
